...
const SYMPTOM_SUGGESTIONS = [
  ...
  "Stomach ache", "Joint pain", "Rash", "Vomiting", "Chills",
  "Loss of appetite", "Muscle aches", "Runny nose", "Insomnia", "Anxiety"
];
...
export default function SymptomCheck({ token, onCheckComplete }) {
    ...
    <div style={styles.wrapper}>
        ...
        <div style={styles.card}>
          ...
          >
            {symptoms.map((s) => (
              <span key={s} style={styles.tag}>
                {s}
                <button onClick={() => removeSymptom(s)} style={styles.tagRemove}>×</button>
              </span>
            ))}
            <input
              ref={inputRef}
          ...
          {suggestions.length > 0 && (
            <div style={styles.suggestions}>
              {suggestions.map((s) => (
                <button key={s} onClick={() => addSymptom(s)} style={styles.suggestionItem}>
                  {s}
                </button>
              ))}
            </div>
      ...
      {step === 2 && (
        <div style={styles.card}>
          <label style={styles.label}>
            <span style={styles.labelDot} />
            Patient Context <span style={styles.optional}>(Optional but helpful)</span>
          </label>
      ...
      {step === 3 && result && (
        <div ref={resultRef}>
          ...
          <div style={styles.resultCard}>
            <h3 style={styles.resultSectionTitle}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ marginRight: 6 }}>
                ...
                <path d="M8 5V8.5L10 10" stroke="#14B8A6" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
              Possible Conditions
            </h3>
          ...
          <div style={styles.resultCard}>
            <h3 style={styles.resultSectionTitle}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ marginRight: 6 }}>
                <path d="M8 1L10 5H15L11 8L13 13L8 10L3 13L5 8L1 5H6L8 1Z" stroke="#14B8A6" strokeWidth="1.5" strokeLinejoin="round"/>
              </svg>
          ...
          <div style={styles.resultCard}>
            <h3 style={styles.resultSectionTitle}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ marginRight: 6 }}>
                <path d="M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" stroke="#14B8A6" strokeWidth="1.5"/>
                <path d="M8 7V11M8 5H8.01" stroke="#14B8A6" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
              General Advice
            </h3>
          ...
          <div style={styles.disclaimer}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{ flexShrink: 0, marginTop: 2 }}>
              <path d="M7 13A6 6 0 1 0 7 1a6 6 0 0 0 0 12z" stroke="#9CA3AF" strokeWidth="1.2"/>
              <path d="M7 6V9M7 4.5H7.01" stroke="#9CA3AF" strokeWidth="1.2" strokeLinecap="round"/>
            </svg>
            <p style={styles.disclaimerText}>{result.aiResponse?.disclaimer}</p>
          </div>

          <div style={styles.btnRow}>
            <button onClick={reset} style={styles.secondaryBtn}>New Check</button>
            <button
